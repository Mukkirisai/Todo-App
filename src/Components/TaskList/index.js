...
const TaskList = ()=>{
    ...
    return(
        <div className="bgContainer">
            ...
            (
            <div className="dv">
                <img src="https://img.freepik.com/premium-vector/businessman-sitting-table-working-laptop-task-checklist-flat-vector-illustration_750391-56.jpg" alt="empty list" className="img"/>
